...
<head>
    ...
    <title>AO KNITTING - Contracts & Agreements</title>
...
<body class="bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-200">
    ...
    <!-- Sidebar -->
    <!-- SIDEBAR CODE REMAINS EXACTLY THE SAME AS IN communication_tracking.blade.php -->
    <!-- Copy the entire sidebar section from communication_tracking.blade.php here -->
    <aside class="sidebar fixed h-screen border-r border-gray-200 dark:border-gray-700 flex flex-col py-6 px-4 overflow-y-auto" id="sidebar">
        ...
        <nav class="flex-1 space-y-2">
            ...
            <a href="{{ route('dashboard.contract') }}" class="sidebar-item active flex items-center space-x-3 py-3 px-4">
            ...
            <a href="{{ route('dashboard.supplier-agreements') }}" class="sidebar-item flex items-center space-x-3 py-3 py-4">
    ...
    <div class="main-content h-screen flex flex-col" id="main-content">
        ...
        <header class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 py-4 px-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold">Contracts & Agreements</h1>
                    <p class="text-gray-500 dark:text-gray-400">Manage all customer contracts, agreements, and legal documents</p>
                </div>
        ...
        <main class="flex-1 p-8 overflow-y-auto">
            <div class="max-w-6xl mx-auto">
                <!-- Welcome Card -->
                <div class="bg-gradient-to-r from-purple-600 to-purple-800 rounded-xl p-8 mb-8 text-white">
                    <h2 class="text-2xl font-bold mb-4">Contracts Dashboard 📄</h2>
                    <p class="mb-6">Manage all customer contracts, supplier agreements, and legal documents in one secure location.</p>
                    <div class="flex space-x-4">
                        <button class="bg-white text-purple-600 px-6 py-2 rounded-lg font-medium hover:bg-purple-50">
                            <i class="fas fa-plus mr-2"></i> Create New Contract
                        </button>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                    <div class="card p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-gray-500 dark:text-gray-400 text-sm">Active Contracts</p>
                                <h3 class="text-2xl font-bold">24</h3>
                            </div>
                            <div class="w-12 h-12 rounded-full bg-green-100 dark:bg-green-900 flex items-center justify-center">
                                <i class="fas fa-file-signature text-green-600 dark:text-green-300"></i>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-gray-500 dark:text-gray-400 text-sm">Pending Renewal</p>
                ...
                <div class="card p-6">
                    <div class="flex items-center justify-between mb-6">
                        <h3 class="text-xl font-bold">Recent Contracts</h3>
                        ...
                        <table class="w-full">
                            <thead>
                                <tr class="border-b border-gray-200 dark:border-gray-700">
                                    <th class="text-left py-3 px-4">Contract ID</th>
                            ...
                            <tbody>
                                <tr class="border-b border-gray-100 dark:border-gray-800">
                                    <td class="py-3 px-4 font-medium">CT-2024-001</td>
                                    <td class="py-3 px-4">
                                    ...
                                    <td class="py-3 px-4">Annual Supply</td>
                                    <td class="py-3 px-4">Jan 15, 2024</td>
                                    <td class="py-3 px-4">Jan 14, 2025</td>
                                    <td class="py-3 px-4">
                                ...
                                <tr class="border-b border-gray-100 dark:border-gray-800">
                                    <td class="py-3 px-4 font-medium">CT-2024-002</td>
                                    <td class="py-3 px-4">
                                        <div class="flex items-center">
                                    ...
                                    <td class="py-3 px-4">Exclusive Supply</td>
                                    <td class="py-3 px-4">Feb 1, 2024</td>
                                    <td class="py-3 px-4">Jan 31, 2025</td>
                                    <td class="py-3 px-4">
